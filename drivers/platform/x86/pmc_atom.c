			 ...
			 unsigned long action, void *data)
{
	...
	/* Avoid false positives, add fused off bits + PMIC I2C to func_dis */
	if (m->d3_sts_1	== byt_d3_sts_1_map) {
		/* BYT */
		func_dis |= BIT_GBE | BIT_LPSS2_F5_I2C5;
		func_dis_2 |= BIT_SMB;
	} else {
		/* CHT */
		func_dis |= BIT_GBE | BIT_LPSS2_F7_I2C7;
		func_dis_2 |= BIT_SMB | BIT_FD_ISH;
	}
